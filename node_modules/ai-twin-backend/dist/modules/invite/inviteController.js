...
const processInviteAcceptance = async (req, res) => {
    try {
        ...
        const { generateId } = await Promise.resolve().then(() => __importStar(require('../../config/database')));
        const eventId = generateId();
        await database_1.db.query('INSERT INTO "Event" (id, "userId", type, meta) VALUES ($1, $2, $3, $4)', [eventId, invite.inviterId, 'invite_accepted', JSON.stringify({ inviteId: invite.id, inviterId: invite.inviterId })]);

...
router.get('/stats/:twinId', jwtCookie_1.extractJWTFromCookie, socialController_1.getTwinStats);
...
router.get('/twin/:twinId/likers', jwtCookie_1.extractJWTFromCookie, socialController_1.getTwinLikers);
router.get('/twin/:twinId/followers', jwtCookie_1.extractJWTFromCookie, socialController_1.getTwinFollowers);
router.get('/twin/:twinId/chatters', jwtCookie_1.extractJWTFromCookie, socialController_1.getTwinChatters);

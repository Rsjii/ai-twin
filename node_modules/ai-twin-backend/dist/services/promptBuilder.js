    ...
    async getLongTermMemories(twinId, userQuery) {
        ...
        try {
            if (userQuery && userQuery.trim().length > 0) {
                return await memoryService_1.memoryService.getRelevantLongTermMemories(twinId, userQuery, 10);
            }
            else {
                return await memoryService_1.memoryService.getLongTermMemories(twinId, undefined, 5);
            }
        }
        catch (error) {

...
class LearningScheduler {
    ...
    start() {
        this.intervalId = setInterval(async () => {
            try {
                logger_1.logger.info('Running scheduled background learning (updating style vector & prompt from feedback)');
        ...
        logger_1.logger.info('Background learning scheduler started (12 hour interval)');
    }
    stop() {
        if (this.intervalId) {

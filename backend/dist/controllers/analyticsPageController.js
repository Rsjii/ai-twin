...
async function getAnalytics(req, res) {
    try {
        ...
        const appError = errors_1.createError.internal('Failed to load analytics', error);
...
async function getAdminAnalytics(req, res) {
    try {
        ...
        const appError = errors_1.createError.internal('Failed to load admin analytics', error);
        return res.status(appError.statusCode).render('error', {
            title: 'Error',
            message: appError.message,
            errorCode: appError.errorCode,
...
async function getAdminAnalyticsPage(req, res) {
    try {
        ...
        const appError = errors_1.createError.internal('Failed to load admin analytics page', error);
        return res.status(appError.statusCode).render('error', {
            title: 'Error',
            message: appError.message,
            errorCode: appError.errorCode,

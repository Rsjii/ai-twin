...
const getPublicProfile = async (req, res) => {
    try {
        ...
        const twinResult = await db.query('SELECT id, "userId", "styleVector", "sampleReply", "isPublic", "publicHandle", "bio", "profileImage", "createdAt" FROM "Twin" WHERE "userId" = $1 ORDER BY "createdAt" DESC LIMIT 1', [user.id]);
...
const logProfileShare = async (req, res) => {
    try {
        ...
        await (0, eventLogger_1.logEvent)(req.session.userId, 'profile_shared', {});

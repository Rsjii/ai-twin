...
router.post('/start', publicChatController_1.startPublicChat);
...
router.get('/:chatId/history', publicChatController_1.getPublicChatHistory);
...
router.delete('/:chatId', publicChatController_1.deletePublicChat);

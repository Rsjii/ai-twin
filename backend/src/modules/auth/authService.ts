                      ...
                      <tr>
                        <td style="padding: 40px 30px;">
                          ...
                          <p style="margin: 0 0 30px 0; color: #666666; font-size: 16px; line-height: 1.5;">
                            ${type === 'signup' ? 'Welcome to TwinOS! Use this code to complete your signup:' : type === 'forgot' ? 'Use this code to reset your password:' : 'Use this code to verify your login:'}
                          </p>
